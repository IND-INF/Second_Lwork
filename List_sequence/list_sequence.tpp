...
template <class T, class Derived>
ListSequence<T,Derived>::ListSequence(const T *items, size_t count){
...
template <class T, class Derived>
const T& ListSequence<T,Derived>::Get(size_t index) const{
    return list->Get(index);
}

template <class T, class Derived>
Sequence<T>* ListSequence<T,Derived>::GetSubsequence(size_t startIndex, size_t endIndex) const{
...
template <class T, class Derived>
Derived* ListSequence<T,Derived>::DirectGetSubsequence(size_t startIndex, size_t endIndex) const{
...
template <class T, class Derived>
Sequence<T>* ListSequence<T,Derived>::InsertAt(const T &item, size_t index){
...
template <class T, class Derived>
Derived* ListSequence<T,Derived>::DirectInsertAt(const T &item, size_t index){

    if(index > list->GetCount()) throw IndexOutOfRange(index, list->GetCount());
