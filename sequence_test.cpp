...
char TestExceptionsArrSeqConcat(){

    bool fail = false;
    int items[4] = {1, 3, -4, 8};
    MutableArraySequence<int> *seq = new MutableArraySequence<int>(items, 4);

    TEST_EXCEPTION_MACRO(seq->DirectConcat(nullptr), BadCollectionCast);
    Sequence<int> *seqPtr = new MutableListSequence<int>;
    TEST_EXCEPTION_MACRO(seq->DirectConcat(seqPtr), BadCollectionCast);
    delete seq;
...
char TestExceptionsListSeqConcat(){
    ...
    TEST_EXCEPTION_MACRO(seq->DirectConcat(nullptr), BadCollectionCast);
    Sequence<int> *seqPtr = new MutableArraySequence<int>;
    TEST_EXCEPTION_MACRO(seq->DirectConcat(seqPtr), BadCollectionCast);
    delete seq;
...
void DoTest(){
    ...
    TEST_COUNTER_MACRO(TestExceptionsArrSeqConcat)
    ...
    TEST_COUNTER_MACRO(TestExceptionsListSeqConcat)
    ...
    std::cout << count << " of 138 tests passed" << std::endl;
